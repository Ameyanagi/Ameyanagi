...
|---------|-------------------|
| <img src="https://raw.githubusercontent.com/Ameyanagi/rexafs/main/assets/brand/rexafs-icon.png" alt="" width="20" /> [rexafs](https://github.com/Ameyanagi/rexafs) | XAS/EXAFS desktop app and published [Rust](https://crates.io/crates/rexafs), [Python](https://pypi.org/project/rexafs/), and [JavaScript/Wasm](https://www.npmjs.com/package/rexafs) libraries; Rust and desktop include fitting, while Python and Wasm expose spectrum processing |
...
<details>
<summary><img src="https://raw.githubusercontent.com/Ameyanagi/phoenix-chem/main/assets/logo.png" alt="" width="20" /> <img src="https://raw.githubusercontent.com/Ameyanagi/ra-library/main/assets/logo.png" alt="" width="20" /> <strong>Safety, risk assessment, and regulatory data</strong></summary>

| Project | Published artifact | Focus |
|---------|--------------------|-------|
| <img src="https://raw.githubusercontent.com/Ameyanagi/phoenix-chem/main/assets/logo.png" alt="" width="20" /> **[PHOENIX](https://github.com/Ameyanagi/phoenix-chem)** | [PyPI](https://pypi.org/project/phoenix-chem/) · [documentation](https://ameyanagi.github.io/phoenix-chem/) | Reactive chemical hazard evaluation and CHETAH-style instability screening; for screening only, with experimental validation required |
...
| <img src="https://raw.githubusercontent.com/Ameyanagi/phoenix-chem/main/assets/logo.png" alt="" width="20" /> [PHOENIX](https://github.com/Ameyanagi/phoenix-chem) | Chemical safety | Reactive chemical hazard evaluation and CHETAH-style screening for [Python](https://pypi.org/project/phoenix-chem/), with [public documentation](https://ameyanagi.github.io/phoenix-chem/) |
